...
export default function ContactDetail() {
  ...
  ) // Ideally relatedTo Contact, but using Account/Opp for now. Let's filter by string match if needed or keep it light.
  const contactOpps = opps.filter((o) => o.accountId === contact.accountId) // Opps in the same account
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {contact.address ? (
                        <>
                          {contact.address} <br />
                          {contact.city}/{contact.state} - CEP {contact.zipCode}
                        </>
                      ) : (
                        '-'
                      )}
